...
- [CLI options](cli-options.md) – Override configuration at runtime when you need a one-off change or want to experiment without editing YAML files (also includes global CLI-only flags like `--timing`).
